...
def main():
    ...
    prereqs_check(default_apps_file_path=args_values.default_apps_file_path)

    match args_values.output_mode:
        case "json" | "csv":
            logging.debug(f"Outputting data in {args_values.output_mode} format")
        ...
        case "prometheus":
            logging.debug(f"Outputting data in Prometheus format, refreshing every {args_values.output_refresh_interval_seconds} seconds")
